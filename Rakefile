...
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.options << '--title' << 'Lumberjack Fluent Device' << '--line-numbers' << '--inline-source' << '--main' << 'README.rdoc'
...
spec_file = File.expand_path('../lumberjack_fluent_device.gemspec', __FILE__)
